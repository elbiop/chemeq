# generate a csv file in the src folder
# due to problems to include csv file in build

import os
from importlib import util

data = '''Source for the periodic table of elements:
...
if installed is not None:
    ...
    if 'periodic_table.csv' not in os.listdir(PATH):
        with open(PATH + "periodic_table.csv", "w") as pt:
            pt.write(data)
